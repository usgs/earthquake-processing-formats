...
public class TravelTimeSessionTest {
  ...
  public static String TRAVELTIMESESSION_STRING =
  ...
  public void writesJSON() {
    ...
    TravelTimeSession travelTimeSessionObject =
    ...
    String jsonString = Utility.toJSONString(travelTimeSessionObject.toJSON());

    // check the data
    try {
      checkData(new TravelTimeSession(Utility.fromJSONString(jsonString)), "WritesJSON");
  ...
  public void readsJSON() {
    ...
    try {
      ...
      checkData(
          new TravelTimeSession(Utility.fromJSONString(TRAVELTIMESESSION_STRING)), "ReadsJSON");
    } catch (ParseException e) {
      e.printStackTrace();
    }
  }
  ...
  public void reload() {
    ...
    travelTimeSessionObject.reload(
        SOURCEDEPTH,
        EARTHMODEL,
        buildPhaseTypes(),
        SOURCELATITUDE,
  ...
  public void copyConstructor() {
    ...
    TravelTimeSession travelTimeSessionObject2 = new TravelTimeSession(travelTimeSessionObject);
  ...
  public void validate() {
    ...
    // use constructor
    TravelTimeSession badtravelTimeSessionObject =
        new TravelTimeSession(
            null,
            EARTHMODEL,
            null,
  ...
  public void checkData(TravelTimeSession travelTimeSessionObject, String TestName) {

    // required
    // check travelTimeSessionObject.distance
    assertEquals(
        TestName + " Source Depth Equals", SOURCEDEPTH, travelTimeSessionObject.SourceDepth, 0);

    // optional
    // travelTimeSessionObject.earthModel
    if (travelTimeSessionObject.EarthModel != null) {
      assertEquals(
          TestName + " Earth Model Equals", EARTHMODEL, travelTimeSessionObject.EarthModel);
    }
    ...
    if ((travelTimeSessionObject.PhaseTypes != null)
      ...
      assertEquals(
          TestName + " Phase Type 1 Equals", PHASETYPE1, travelTimeSessionObject.PhaseTypes.get(0));

      // check travelTimeSessionObject.phaseTypes[1]
      assertEquals(
          TestName + " Phase Type 2 Equals", PHASETYPE2, travelTimeSessionObject.PhaseTypes.get(1));

      // check travelTimeSessionObject.phaseTypes[2]
      assertEquals(
          TestName + " Phase Type 3 Equals", PHASETYPE3, travelTimeSessionObject.PhaseTypes.get(2));
    }

    // check travelTimeSessionObject.sourceLatitude
    if (travelTimeSessionObject.SourceLatitude != null) {
      assertEquals(
          TestName + " Latitude Equals", SOURCELATITUDE, travelTimeSessionObject.SourceLatitude, 0);
    }
    ...
    if (travelTimeSessionObject.SourceLongitude != null) {
      assertEquals(
          ...
          SOURCELONGITUDE,
          travelTimeSessionObject.SourceLongitude,
          0);
    }
    ...
    if (travelTimeSessionObject.IsPlot != null) {
      assertEquals(TestName + " Is Plot Equals ", travelTimeSessionObject.IsPlot, ISPLOT);
    }
  }
