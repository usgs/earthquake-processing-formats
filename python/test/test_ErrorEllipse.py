...
class TestErrorEllipse(unittest.TestCase):
    ...
    def test_init(self):
        ...
        self.assertEqual(
            errorEllipse.maximumHorizontalProjection, self.MAXIMUMHORIZONTALPROJECTION
        )
        self.assertEqual(
            errorEllipse.maximumVerticalProjection, self.MAXIMUMVERTICALPROJECTION
        )
        self.assertEqual(
            errorEllipse.equivalentHorizontalRadius, self.EQUIVALENTHORIZONTALRADIUS
        )
