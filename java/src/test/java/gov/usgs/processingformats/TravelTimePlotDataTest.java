...
public class TravelTimePlotDataTest {
  ...
  public static String BRANCH_STRING =
      "{\"Phase\":\"Pg\","
          + "\"Samples\":[{\"Distance\":1.2,\"Observability\":0.34,"
  ...
  public static String BRANCH2_STRING =
      "{\"Phase\":\"Sg\","
  ...
  public void writesJSON() {
    ...
    TravelTimePlotData travelTimePlotDataObject =
        new TravelTimePlotData(MAXIMIUMTRAVELTIME, buildBranchData());

    // write out to a string
    String jsonString = Utility.toJSONString(travelTimePlotDataObject.toJSON());

    // check the data
    try {
      checkData(new TravelTimePlotData(Utility.fromJSONString(jsonString)), "WritesJSON");
  ...
  public void readsJSON() {
    ...
    try {
      ...
      checkData(
          new TravelTimePlotData(Utility.fromJSONString(TRAVELTIMEPLOTDATA_STRING)), "ReadsJSON");
    } catch (ParseException e) {
      e.printStackTrace();
    }
  }
  ...
  public void copyConstructor() {
    ...
    TravelTimePlotData travelTimePlotDataObject2 = new TravelTimePlotData(travelTimePlotDataObject);
  ...
  public void validate() {
    ...
    // use constructor
    TravelTimePlotData badTravelTimePlotDataObject = new TravelTimePlotData(null, null);
  ...
  public void checkData(TravelTimePlotData travelTimePlotDataObject, String TestName) {

    // check travelTimePlotDataObject.maximumTravelTime
    assertEquals(
        TestName + " MaximumTravelTime Equals",
        MAXIMIUMTRAVELTIME,
        travelTimePlotDataObject.MaximumTravelTime,
        0);

    // check branch data
    // check number of branches
    assertEquals(
        TestName + " Number of Branches Equals",
        (int) NUMBRANCHES,
        travelTimePlotDataObject.Branches.size(),
        0);

    // check travelTimePlotDataBranchObject.phase
    assertEquals(
        TestName + " Phase Equals", PHASE1, travelTimePlotDataObject.Branches.get(0).Phase);
    ...
    assertEquals(
        ...
        (int) NUMSAMPLES,
        travelTimePlotDataObject.Branches.get(0).Samples.size(),
        0);
    ...
    assertEquals(
        ...
        DISTANCE1,
        travelTimePlotDataObject.Branches.get(0).Samples.get(0).Distance,
        0);
    ...
    assertEquals(
        ...
        TRAVELTIME1,
        travelTimePlotDataObject.Branches.get(0).Samples.get(0).TravelTime,
        0);
    ...
    assertEquals(
        ...
        STATISTICALSPREAD1,
        travelTimePlotDataObject.Branches.get(0).Samples.get(0).StatisticalSpread,
        0);
    ...
    assertEquals(
        ...
        OBSERVABILITY1,
        travelTimePlotDataObject.Branches.get(0).Samples.get(0).Observability,
        0);
    ...
    assertEquals(
        TestName + " Distance Equals",
        DISTANCE12,
        travelTimePlotDataObject.Branches.get(0).Samples.get(1).Distance,
        0);
    ...
    assertEquals(
        TestName + " Travel Time Equals",
        TRAVELTIME12,
        travelTimePlotDataObject.Branches.get(0).Samples.get(1).TravelTime,
        0);
    ...
    assertEquals(
        TestName + " Statistical Spread Equals",
        STATISTICALSPREAD12,
        travelTimePlotDataObject.Branches.get(0).Samples.get(1).StatisticalSpread,
        0);
    ...
    assertEquals(
        TestName + " Observability Equals",
        OBSERVABILITY12,
        travelTimePlotDataObject.Branches.get(0).Samples.get(1).Observability,
        0);

    // check travelTimePlotDataBranchObject.phase
    assertEquals(
        TestName + " Phase Equals", PHASE2, travelTimePlotDataObject.Branches.get(1).Phase);
    ...
    assertEquals(
        TestName + " Number of Samples Equals",
        (int) NUMSAMPLES,
        travelTimePlotDataObject.Branches.get(1).Samples.size(),
        0);
    ...
    assertEquals(
        TestName + " Distance Equals",
        DISTANCE2,
        travelTimePlotDataObject.Branches.get(1).Samples.get(0).Distance,
        0);
    ...
    assertEquals(
        TestName + " Travel Time Equals",
        TRAVELTIME2,
        travelTimePlotDataObject.Branches.get(1).Samples.get(0).TravelTime,
        0);
    ...
    assertEquals(
        TestName + " Statistical Spread Equals",
        STATISTICALSPREAD2,
        travelTimePlotDataObject.Branches.get(1).Samples.get(0).StatisticalSpread,
        0);
    ...
    assertEquals(
        TestName + " Observability Equals",
        OBSERVABILITY2,
        travelTimePlotDataObject.Branches.get(1).Samples.get(0).Observability,
        0);
    ...
    assertEquals(
        TestName + " Distance Equals",
        DISTANCE22,
        travelTimePlotDataObject.Branches.get(1).Samples.get(1).Distance,
        0);
    ...
    assertEquals(
        TestName + " Travel Time Equals",
        TRAVELTIME22,
        travelTimePlotDataObject.Branches.get(1).Samples.get(1).TravelTime,
        0);
    ...
    assertEquals(
        TestName + " Statistical Spread Equals",
        STATISTICALSPREAD22,
        travelTimePlotDataObject.Branches.get(1).Samples.get(1).StatisticalSpread,
        0);
    ...
    assertEquals(
        TestName + " Observability Equals",
        OBSERVABILITY22,
        travelTimePlotDataObject.Branches.get(1).Samples.get(1).Observability,
        0);
  }
  ...
  public ArrayList<TravelTimePlotDataBranch> buildBranchData() {
    ...
    // branches
    try {
      newBranchData.add(new TravelTimePlotDataBranch(Utility.fromJSONString(BRANCH_STRING)));
      newBranchData.add(new TravelTimePlotDataBranch(Utility.fromJSONString(BRANCH2_STRING)));
    } catch (ParseException e) {
      e.printStackTrace();
    }
