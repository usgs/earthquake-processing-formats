...
public class ErrorEllipseAxis implements ProcessingInt {
  ...
  public Double Dip;
	...
	/**
	 * The constructor for the ErrorEllipseAxis class. Initializes members to null
	 * values.
	 */
  ...
  /**
	 ...
	 *
	 * @param newError
	 *            - A Double containing the length of the axis of the
	 *            error ellipsoid in kilometers
	 * @param newAzimuth
	 *            - A Double containing the azimuth of the axis of the
	 *            error ellipsoid in degrees
	 * @param newDip
	 *            - A Double containing the dip of the axis of error
	 ...
	 * Reload Function
	 *
	 * The reload function for the ErrorEllipseAxis class. Initializes members to
	 * provided values.
	 *
	 * @param newError
	 *            - A Double containing the length of the axis of the
