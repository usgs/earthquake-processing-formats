...
class TestLocationRequest(unittest.TestCase):
    ...
    JSONSTRING = '{"Type": "RayLoc", "SourceLatitude": 40.3344, "SourceLongitude": -121.44, "SourceDepth": 32.44, "SourceOriginTime": "2019-05-21T13:03:59.000Z", "InputData": [{"ID": "12GFH48776857", "Site": {"Station": "BOZ", "Network": "US", "Latitude": 45.59697, "Longitude": -111.62967, "Elevation": 1589.0, "Channel": "BHZ", "Location": "00"}, "Source": {"AgencyID": "US", "Author": "TestAuthor", "Type": "Unknown"}, "Time": "2015-12-28T21:32:24.017Z", "Affinity": 1.2, "Quality": 0.45, "Use": true, "PickedPhase": "P", "AssociatedPhase": "P", "LocatedPhase": "P", "Residual": 1.05, "Distance": 2.65, "Azimuth": 21.5, "Weight": 2.65, "Importance": 3.8}], "ID": "12345678", "Source": {"AgencyID": "US", "Author": "TestAuthor", "Type": "Unknown"}, "EarthModel": "ak135", "SlabResolution": "2spd", "IsLocationNew": false, "IsLocationHeld": false, "IsDepthHeld": false, "IsBayesianDepth": true, "BayesianDepth": 66.7, "BayesianSpread": 20.3, "UseSVD": true, "ReassessInitialPhaseIDs": true}'
    DICT = {
        "ID": "12345678",
        ...
        "SourceLatitude": 40.3344,
        "SourceLongitude": -121.44,
        "SourceOriginTime": "2019-05-21T13:03:59.000Z",
        "SourceDepth": 32.44,
        "InputData": [
            {
                "ID": "12GFH48776857",
    ...
    def test_init(self):
        ...
        # earthmodel has a default so it always exists
        self.assertTrue(hasattr(locationRequest, "earthModel"))
        # slabResolution has a default so it always exists
        ...
        locationRequest = processingformats.locationRequest.LocationRequest(
            ...
            self.ISLOCATIONHELD,
            self.ISDEPTHHELD,
            self.ISBAYESIANDEPTH,
            self.BAYESIANDEPTH,
            self.BAYESIANSPREAD,
            self.REASSESSINITIALPHASEIDS,
            self.USESVD,
        )
        ...
        self.assertEqual(
            locationRequest.reassessInitialPhaseIDs, self.REASSESSINITIALPHASEIDS
        )
