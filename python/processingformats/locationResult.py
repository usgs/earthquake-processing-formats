...
class LocationResult:
    ...
    def __init__(
        ...
        newSource=None,
        newHypocenter=None,
        newSupportingData=None,
        newAssociatedStations=None,
        newAssociatedPhases=None,
        newUsedStations=None,
        newUsedPhases=None,
        newGap=None,
        newSecondaryGap=None,
        newMinimumDistance=None,
        newRMS=None,
        newQuality=None,
        newBayesianDepth=None,
        newBayesianRange=None,
        newDepthImportance=None,
        newLocatorExitCode=None,
        newErrorEllipse=None,
    ):
