...
class TestLocationResult(unittest.TestCase):
    ...
    def test_init(self):
        ...
        self.assertEqual(locationResult.errorEllipse.e0.error, self.ERRORELLIPSE.e0.error)
        self.assertEqual(locationResult.errorEllipse.e0.azimuth, self.ERRORELLIPSE.e0.azimuth)
        self.assertEqual(locationResult.errorEllipse.e0.dip, self.ERRORELLIPSE.e0.dip)
        self.assertEqual(locationResult.errorEllipse.e1.error, self.ERRORELLIPSE.e1.error)
        self.assertEqual(locationResult.errorEllipse.e1.azimuth, self.ERRORELLIPSE.e1.azimuth)
        self.assertEqual(locationResult.errorEllipse.e1.dip, self.ERRORELLIPSE.e1.dip)
        self.assertEqual(locationResult.errorEllipse.e2.error, self.ERRORELLIPSE.e2.error)
        self.assertEqual(locationResult.errorEllipse.e2.azimuth, self.ERRORELLIPSE.e2.azimuth)
        self.assertEqual(locationResult.errorEllipse.e2.dip, self.ERRORELLIPSE.e2.dip)
        self.assertEqual(locationResult.errorEllipse.maximumHorizontalProjection, self.ERRORELLIPSE.maximumHorizontalProjection)
        self.assertEqual(locationResult.errorEllipse.maximumVerticalProjection, self.ERRORELLIPSE.maximumVerticalProjection)
        self.assertEqual(locationResult.errorEllipse.equivalentHorizontalRadius, self.ERRORELLIPSE.equivalentHorizontalRadius)
